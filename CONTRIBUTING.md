...
Real-device validation results use the minimal fixture and mandatory privacy
review in [`validation/README.md`](validation/README.md). Never commit a full
diagnostic report, including a redacted one. A confirmed incorrect detection
must have both a tracking issue and a regression test before it is recorded as
validation evidence.
